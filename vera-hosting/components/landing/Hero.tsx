  ...
  return (
    <div className="relative pt-32 pb-20 min-h-screen flex flex-col justify-center overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        {/* Headline */}
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-white tracking-tight mb-6 sm:mb-8 leading-tight animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          Automated Healthcare <br className="hidden sm:block" />
        ...
        {/* Subhead */}
        <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
