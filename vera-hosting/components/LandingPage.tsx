...
import RequestAccessModal from './landing/RequestAccessModal';
...
const LandingPage: React.FC<LandingPageProps> = ({ onLogin }) => {
    ...
    return (
        <div className="min-h-screen text-slate-900 dark:text-gray-200 font-sans selection:bg-emerald-500/30 selection:text-emerald-700 dark:selection:text-emerald-200">
            <BackgroundGrid />
            <Navbar onRequestAccess={() => setShowAccessModal(true)} />
            <main>
                ...
                <section className="py-24 relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                        ...
                        <button className="bg-emerald-600 text-white dark:bg-white dark:text-black px-8 py-4 rounded-lg font-bold text-lg hover:bg-emerald-700 dark:hover:bg-gray-100 transition-colors shadow-lg shadow-emerald-500/20 dark:shadow-[0_0_40px_rgba(255,255,255,0.3)]" onClick={() => setShowAccessModal(true)}>
                            Request Access
                        </button>
                    </div>
                </section>
