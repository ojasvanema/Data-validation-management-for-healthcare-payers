...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-neutral-950/80 backdrop-blur-md border-b border-white/5 py-4' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-2 group cursor-pointer">
          ...
          <span className="text-xl font-bold tracking-tight text-white font-sans">
            Health<span className="text-emerald-400">Guard</span>
          </span>
        </div>
